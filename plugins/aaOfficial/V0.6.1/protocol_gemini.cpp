// cl.exe /LD /O2 /GS- /GR- /EHa- plugins\gemini.cpp /link /NODEFAULTLIB /ENTRY:DllMain /MACHINE:x64 kernel32.lib user32.lib gdi32.lib ws2_32.lib secur32.lib /OUT:plugins\gemini.dll
